...
class LanguageProvider extends ChangeNotifier {
  ...
  final Map<String, Map<String, String>> _localizedStrings = {
    'tr': {
      ...
      'cancel_button': 'İPTAL',
      'video_label': 'Video',
      'empty_field_warning': 'Tüm alanları doldurunuz!',
      'video_missing_warning':'Video yükleyin!',
      'video_and_title_missing_warning':'Video ve başlık eksik!',
      'deleting_please_wait':'Siliniyor, lütfen bekleyin...',
    ...
    'en': {
      ...
      'video_label': 'Video',
      'empty_field_warning': 'Please fill in all fields!',
      'video_missing_warning':'Please upload video!',
      'video_and_title_missing_warning':'Video and title are missing!',
      'deleting_please_wait':'Deleting, please wait...',
      'speaker_deleted_success': 'Speaker successfully deleted',
      'content_deleted_success': 'Content successfully deleted',
      'error': 'Error',
    },
    'ru': {
      ...
      'video_label': 'Видео',
      'empty_field_warning': 'Пожалуйста, заполните все поля!',
      'video_missing_warning':'Пожалуйста, загрузите видео!',
      'video_and_title_missing_warning':'Видео и заголовок отсутствуют!',
      'deleting_please_wait':'Удаление, пожалуйста подождите...',
      'speaker_deleted_success': 'Докладчик успешно удален',
      'content_deleted_success': 'Контент успешно удален',
      'error': 'Ошибка',
    },
    'ar': {
      ...
      'cancel_button': 'إلغاء',
      'video_label': 'فيديو',
      'empty_field_warning': 'يرجى ملء جميع الحقول!',
      'video_missing_warning':'يرجى تحميل الفيديو!',
      'video_and_title_missing_warning':'الفيديو والعنوان مفقودان!',
      'deleting_please_wait':'جاري الحذف، يرجى الانتظار...',
      'speaker_deleted_success': 'تم حذف المتحدث بنجاح',
